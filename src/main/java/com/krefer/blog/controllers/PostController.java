...
import com.krefer.blog.config.AppConstants;
...
import com.krefer.blog.services.FileService;
...
public class PostController {
	...
	public ResponseEntity<PostResponse> getAllPosts(
			...
			@RequestParam(value = "soryDir", defaultValue = AppConstants.SORT_DIR, required = false) String sortDir) {
	...
	public ResponseEntity<List<PostDto>> searchPostByTitle(@PathVariable("keywords") String keywords) {
		List<PostDto> result = this.postService.getPostBySearch(keywords);
	...
	// download image method to serve file
